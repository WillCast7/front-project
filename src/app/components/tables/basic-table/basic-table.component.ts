...
import { CustomerListInitializer, CustomerListNamesInterface } from '../../../models/mercadeo/customerListNames-interface';
...
export class BasicTableComponent {
  ...
  displayedNames: CustomerListNamesInterface = CustomerListInitializer;
  dataSource: any = []; 
  ...
  @Input() set names(names: CustomerListNamesInterface) {
